...
![Weber Cooks - begin](/docs/screenshot-menu.png?raw=true "Weber Cooks - menu")
![Weber Cooks - words](/docs/screenshot-order.png?raw=true "Weber Cooks - order")
![Weber Cooks - placed](/docs/screenshot-placed.png?raw=true "Weber Cooks - placed")
...
```
https://github.com/LennartJKlein/LennartKlein-pset5.git
```
